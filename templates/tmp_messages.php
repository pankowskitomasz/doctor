            ...
            <div class="mdc-card w-100 h-100 border border-blue p-2">
                <form action=""
                    ...
                    <div class="w-100 mb-3">
                        <button class="mdc-button text-blue float-left"
                            name="messages"
                            type="submit">
                            <span class="mdc-button__ripple"></span>
                            Show All
                        ...
                        <table class="mdc-data-table__table w-100">
                            <thead>
                                <tr class="mdc-data-table__header-row border-b border-blue">
                                    <th class="mdc-data-table__header-cell text-blue w-40px p-1">ID</th>
                                    <th class="mdc-data-table__header-cell text-blue">Name</th>
                                    <th class="mdc-data-table__header-cell text-blue">Date</th>
                                    <th class="mdc-data-table__header-cell text-blue" ></th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php 
                                    ...
                                    for($i=$pstart;$i<count($tab) && $i<$pend;$i++){
                                        echo "<tr  class=\"mdc-data-table__row\">".
                                            ...
                                            "<button type='submit' name='msgdelete' class='mdc-button mdc-button--outlined border-blue text-blue float-right minw-30px' value='".$tab[$i][0]."'>X</button>".
                                            "<button type='submit' name='msginfo' class='mdc-button mdc-button--outlined border-blue text-blue float-right minw-30px' value='".$tab[$i][0]."'>i</button>".                                            
                                            "</td></tr>";
                                    }
                                ?>    
                            </tbody>
